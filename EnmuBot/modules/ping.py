...
from EnmuBot.modules.sudoers import bot_sys_stats
...
from EnmuBot import StartTime, dispatcher, pbot
...
PING_IMG = "https://telegra.ph/file/2e3f7f8900ec37599472d.jpg"
    ...
    update.effective_message.reply_photo(
        ...
        parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="Enmu System Stats", callback_data="stats_callback")
                  ]
                ]
            ),
        )
