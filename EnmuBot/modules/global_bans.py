...
import EnmuBot.modules.sql.global_bans_sql as sql
from EnmuBot.modules.sql.users_sql import get_user_com_chats
from EnmuBot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from EnmuBot.modules.helper_funcs.misc import send_to_list
...
def __stats__():
    return f"𒊹 {sql.num_gbanned_users()} gbanned users."
...
UNGBAN_HANDLER = CommandHandler("rmgban", ungban, run_async=True)
