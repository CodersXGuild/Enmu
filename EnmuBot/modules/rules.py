...
import EnmuBot.modules.sql.rules_sql as sql
from EnmuBot import dispatcher
from EnmuBot.modules.helper_funcs.chat_status import user_admin
from EnmuBot.modules.helper_funcs.string_handling import markdown_parser
...
def __stats__():
    return f"𒊹 {sql.num_chats()} chats have rules set."
