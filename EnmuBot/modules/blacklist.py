...
import EnmuBot.modules.sql.blacklist_sql as sql
from EnmuBot import dispatcher, LOGGER
from EnmuBot.modules.disable import DisableAbleCommandHandler
from EnmuBot.modules.helper_funcs.chat_status import user_admin, user_not_admin
...
from EnmuBot.modules.warns import warn
...
def __stats__():
    return "𒊹 {} blacklist triggers, across {} chats.".format(
