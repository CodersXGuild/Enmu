...
from EnmuBot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
...
from EnmuBot.modules.helper_funcs.chat_status import user_admin, connection_status
from EnmuBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from EnmuBot.modules.helper_funcs.msg_types import get_note_type
...
def __stats__():
    return f"𒊹 {sql.num_notes()} notes, across {sql.num_chats()} chats."
