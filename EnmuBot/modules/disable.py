...
from EnmuBot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from EnmuBot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from EnmuBot.modules.sql import disable_sql as sql
    ...
    def __stats__():
        return f"𒊹 {sql.num_disabled()} disabled items, across {sql.num_chats()} chats."
