...
from EnmuBot import DEV_USERS, ERROR_LOGS, dispatcher
from EnmuBot.modules.helper_funcs.decorators import enmucmd
    ...
    if context.error not in errors:
        ...
        context.bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("See The Error And Fix me!", url=url)]],
            ),
            parse_mode=ParseMode.HTML,
        )


@enmucmd(command="errors")
