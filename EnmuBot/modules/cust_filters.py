...
from EnmuBot import dispatcher, LOGGER, DRAGONS
from EnmuBot.modules.disable import DisableAbleCommandHandler
from EnmuBot.modules.helper_funcs.handlers import MessageHandlerChecker
from EnmuBot.modules.helper_funcs.chat_status import user_admin
from EnmuBot.modules.helper_funcs.extraction import extract_text
from EnmuBot.modules.helper_funcs.filters import CustomFilters
from EnmuBot.modules.helper_funcs.misc import build_keyboard_parser
from EnmuBot.modules.helper_funcs.msg_types import get_filter_type
from EnmuBot.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from EnmuBot.modules.sql import cust_filters_sql as sql
from EnmuBot.modules.connection import connected
from EnmuBot.modules.helper_funcs.alternate import send_message, typing_action
...
def rmall_callback(update, context):
    ...
    if query.data == "filters_rmall":
        ...
        if member.status == "administrator":
            query.answer("Only owner of the chat can do this.")
        if member.status == "member":
            query.answer("You need to be Group Owner to do this.")
...
def __stats__():
    return "𒊹 {} filters, across {} chats.".format(sql.num_filters(), sql.num_chats())
