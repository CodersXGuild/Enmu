...
from EnmuBot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from EnmuBot.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
from EnmuBot import REDIS
from EnmuBot.modules.users import get_user_id

from EnmuBot.modules.helper_funcs.alternate import send_message
from EnmuBot.modules.helper_funcs.readable_time import get_readable_time

AFK_GROUP = 7
AFK_REPLY_GROUP = 8

AFKVID = "https://graph.org//file/a289adb0b3cc515c3615c.mp4"
...
def afk(update, context):
    ...
    try:
        update.effective_message.reply_video(
            AFKVID,caption="Indulge into the world of my dreams {}!".format(fname))
    except BadRequest:
        pass
    ...
    if res:
        ...
        try:
            options = [
                ...
                "Hey Dear {} , Welcome Back! We Were Apart For {}",
                "{} Came Back After World War! Time Taken: {}",
