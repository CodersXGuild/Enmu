...
import EnmuBot.modules.sql.welcome_sql as sql
from EnmuBot import (
    DEV_USERS,
    OWNER_ID,
    DRAGONS,
...
from EnmuBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from EnmuBot.modules.helper_funcs.msg_types import get_welcome_type
...
YASH_WELC = "https://graph.org//file/b79a030cc19e5bc7a186b.jpg"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                YASH_WELC, caption = f"My Owner Flame X Hashira [ @TitanSurveyer ] Has Arrived At The Chat", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            if new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "Whoa! Someone from Upper Moons just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            backup_message = random.choice(sql.DEFAULT_WELCOME_MESSAGES)
        ...
        if left_mem:
            ...
            if cust_goodbye:
                if cust_goodbye == sql.DEFAULT_GOODBYE_MESSAGES:
                    cust_goodbye = random.choice(sql.DEFAULT_GOODBYE_MESSAGES)
                ...
                res = random.choice(sql.DEFAULT_GOODBYE_MESSAGES)
                keyb = []
