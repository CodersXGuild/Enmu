...
from EnmuBot import REM_BG_API_KEY
from EnmuBot.events import register
from EnmuBot import telethn as tbot
...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.reply(
            "remove.bg API returned Errors. Please report to @TitanHeadQuaters\n`{}".format(
...
def ReTrieveFile(input_file_name):
    headers = {
        'X-API-Key': 'xeY3WpZP5bgmze4HoGNBHGsk',
    }
    files = {
