...
import EnmuBot.modules.sql.global_bans_sql as gban_sql
import EnmuBot.modules.sql.users_sql as user_sql
from EnmuBot import DEV_USERS, OWNER_ID, dispatcher
from EnmuBot.modules.helper_funcs.chat_status import dev_plus
...
DB_CLEANUP_HANDLER = CommandHandler("dataclean", dbcleanup, run_async=True)
